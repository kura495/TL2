...
class MYADDON_OT_player_spawn_Import_symbol(bpy.types.Operator):
    bl_idname = "myaddon.myaddon_ot_player_spawn_import_symbol"
...
class MYADDON_OT_enemy_spawn_Import_symbol(bpy.types.Operator):
    bl_idname = "myaddon.myaddon_ot_enemy_spawn_import_symbol"
